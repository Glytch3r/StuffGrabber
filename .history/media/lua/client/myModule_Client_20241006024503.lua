...
function StuffGrabber.getStu ]]ffList()
...
context:setOptionChecked(option, checked)
context:getOptionFromName(getText("ContextMenu_Destroy"))
context:removeOptionByName(getText("ContextMenu_Destroy"))
context:removeLastOption()
context:insertOptionAfter("Drink", "Drink")
context:insertOptionBefore("Drink", "Drink")
