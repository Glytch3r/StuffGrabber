...
--[[
    ...
    while inv:contains(toDrop)  do
        self.maxTime = 50
        local item = inv:FindAndReturn(toDrop)
        ISTimedActionQueue.add(StuffGrabber_Drop:new(pl, item, pl:getCurrentSquare(), ZombRand(3), ZombRand(3), 0, 0, true, 50))
    end
